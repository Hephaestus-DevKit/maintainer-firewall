...
Please do not open a public issue for a vulnerability in this project. Use [GitHub private vulnerability reporting](https://github.com/Hephaestus-DevKit/maintainer-firewall/security/advisories/new) if it is enabled, or contact the maintainers through the security contact listed by the repository owner.
